...
public class Hanger extends SubsystemBase {
    public enum Position {
        ...
        public Angle motorAngle() {
            final AngleUnit angleMeasure = Inches.of(inches).divideRatio(kHangerExtensionPerMotorAngle);
    ...
    private Distance motorAngleToExtension(Angle motorAngle) {
        final DistanceUnit extensionMeasure = motorAngle.timesRatio(kHangerExtensionPerMotorAngle);
